...
struct SettingsView: View {
    ...
    static let setupCopy =
        ...
        + "Antigravity, GLM, Grok, OpenCode or GitHub Copilot in VS Code, "
    ...
    static let keychainCopy =
        "macOS will ask once for permission to read Claude Code's, Antigravity's "
        + "and VS Code's saved logins. Choose Always Allow — plain Allow makes "
